...
var _materialIcnos = require('./material-icnos.list');

var _materialIcnos2 = _interopRequireDefault(_materialIcnos);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var preparedList = [];
_materialIcnos2.default.categories.forEach(function (category) {
...
exports.default = {
  ...
  computed: {
    listItems: function listItems() {
      ...
      if (this.search) {
        return preparedList.filter(function (item) {
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"uk-form-row"},[_c('label',{staticClass:"uk-form-label"},[_vm._v("Icon Name")]),_vm._v(" "),_c('div',{staticClass:"select select--inline",class:{'select--open':_vm.openSelect}},[_c('a',{staticClass:"select__btn ellipsis",on:{"click":function($event){$event.stopPropagation();_vm.openSelect=!_vm.openSelect}}},[_vm._v("\n                "+_vm._s(_vm.model.name || 'Please select...')+"\n            ")]),_vm._v(" "),_c('div',{staticClass:"select__dropdown",style:({'display':_vm.openSelect?'block':'none'})},[_c('div',{staticClass:"select__type-search"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.search),expression:"search"}],staticClass:"uk-width-1-1 js-term-input",attrs:{"type":"text","placeholder":"Search"},domProps:{"value":(_vm.search)},on:{"input":function($event){if($event.target.composing){ return; }_vm.search=$event.target.value}}})]),_vm._v(" "),_c('div',{staticStyle:{"max-height":"200px","overflow-y":"auto"}},_vm._l((_vm.listItems),function(item){return _c('div',{key:item.id,staticClass:"select__opt-box"},[_c('div',{on:{"click":function($event){_vm.selectItem(item)}}},[_vm._v("\n                            "+_vm._s(item.name)+"\n                        ")])])}),0)])])])])}
__vue__options__.staticRenderFns = []

},{"./material-icnos.list":3,"vueify/lib/insert-css":1}],3:[function(require,module,exports){
module.exports={
  "categories": [{
    "name": "action",
    "key": "action",
